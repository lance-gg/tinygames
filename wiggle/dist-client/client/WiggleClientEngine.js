import { ClientEngine, ExtrapolateStrategy } from 'lance-gg';
...
export default class WiggleClientEngine extends ClientEngine {
    ...
    sendMouseAngle() {
        let player = this.gameEngine.world.queryOneObject({ playerId: this.gameEngine.playerId, instanceType: Wiggle });
        if (this.mouseY === null || player === null)
            return;
